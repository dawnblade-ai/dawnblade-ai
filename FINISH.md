...
## 1. WHERE WE ARE — measured at v2.83, refreshed at v3.09

```
npm test          1127 green — 0 skipped with a live DB cached, and
...
deployed          APP_VER 3.09, all 22 engine/*.js on main
```
