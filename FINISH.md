...
## 1. WHERE WE ARE — measured at v2.83, refreshed at v3.03

```
npm test          1076 green — 0 skipped with a live DB cached, and
...
deployed          APP_VER 3.03, all 22 engine/*.js on main
```
