...
## 1. WHERE WE ARE — measured at v2.83, refreshed at v3.15

```
npm test          1149 green — 0 skipped with a live DB cached, and
...
deployed          APP_VER 3.15, all 22 engine/*.js on main
```
