...
## 1. WHERE WE ARE — measured at v2.83, refreshed at v3.14

```
npm test          1150 green — 0 skipped with a live DB cached, and
...
deployed          APP_VER 3.14, all 22 engine/*.js on main
```
