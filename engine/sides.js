...
const SIDE_FIELDS = [
  ...
  "counters","weaponUsed","heroTapped","buffNext","buffQ","gaNext","gaNextQ","costOff","instantNextQ","defCapNext","wardRider","runeHitNext",
...
function makeSide(o){
  ...
  return {
    ...
    res: 0, ap: 1, wasted: 0,
    counters: {}, weaponUsed: {}, heroTapped: false, buffNext: 0, buffQ: [], gaNext: false, gaNextQ: [], costOff: [], instantNextQ: [], defCapNext: [], wardRider: [], runeHitNext: 0,
