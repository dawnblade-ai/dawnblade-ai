...
const SIDE_FIELDS = [
  ...
  "counters","weaponUsed","buffNext","buffQ","gaNext","gaNextQ","costOff","instantNextQ","runeHitNext",
...
function makeSide(o){
  ...
  return {
    ...
    res: 0, ap: 1, wasted: 0,
    counters: {}, weaponUsed: {}, buffNext: 0, buffQ: [], gaNext: false, gaNextQ: [], costOff: [], instantNextQ: [], runeHitNext: 0,
