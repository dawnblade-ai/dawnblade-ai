...
function seat(sd){
  ...
  return {
    ...
    status: {amp: sd.amp, ward: sd.ward, awd: sd.awd, wardTurn: sd.wardTurn, awdTurn: sd.awdTurn,
      ...
      atkBuff: sd.atkBuff, defMod: sd.defMod, gaNext: sd.gaNext, gaNextQ: sd.gaNextQ, costOff: sd.costOff, instantNextQ: sd.instantNextQ, defCapNext: sd.defCapNext, defActionBuff: sd.defActionBuff, wardRider: sd.wardRider, hitNext: sd.hitNext, ctrEnd: sd.ctrEnd, weaponUsed: sd.weaponUsed, heroTapped: sd.heroTapped},
    hist: sd.hist
  };
}
