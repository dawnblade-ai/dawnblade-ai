...
function seat(sd){
  ...
  return {
    ...
    status: {amp: sd.amp, ward: sd.ward, awd: sd.awd,
      ...
      atkBuff: sd.atkBuff, defDebuff: sd.defDebuff, gaNext: sd.gaNext, gaNextQ: sd.gaNextQ, costOff: sd.costOff, instantNextQ: sd.instantNextQ, defCapNext: sd.defCapNext, defActionBuff: sd.defActionBuff, wardRider: sd.wardRider, weaponUsed: sd.weaponUsed, heroTapped: sd.heroTapped},
    hist: sd.hist
  };
}
